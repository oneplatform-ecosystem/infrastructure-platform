...
output "primary_access_key" {
  description = "The primary access key for the Azure Speech Services"
  value       = var.enabled ? azurerm_cognitive_account.this[0].primary_access_key : null
  sensitive   = true
}

output "secondary_access_key" {
  description = "The secondary access key for the Azure Speech Services"
...
# Labels and Tags
output "tags" {
  description = "The tags applied to the Azure Speech Services"
